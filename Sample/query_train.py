...
TEST_SUITE_CLASS_NAME = "QueryTrainSchedule"


class QueryTrainSchedule(unittest.TestCase):
    def __init__(self, driver, opts):
        super(QueryTrainSchedule, self).__init__("test_query_train_schedule")
    ...
    def setUp(self):
        ...
        self.base_url = self.profile.param("base_url", "http://twtraffic.tra.gov.tw/")
    ...
    def test_query_train_schedule(self):
        param = self.profile.param
        driver = self.driver
        driver.get(self.base_url + "/twrail/TW_Quicksearch.aspx")
        driver.find_element_by_xpath("//div[@id='right']/form/table/tbody/tr/td/table/tbody/tr/td/fieldset/table/tbody/tr/td[3]/label[2]").click()
        time.sleep(self.wait_time)
        driver.find_element_by_id("lbf_1008").click()
        time.sleep(self.wait_time)
        driver.find_element_by_xpath("//div[@id='right']/form/table/tbody/tr/td/table/tbody/tr/td/fieldset[2]/table/tbody/tr/td[3]/label[12]").click()
        time.sleep(self.wait_time)
        driver.find_element_by_id("lbt_1238").click()
        time.sleep(self.wait_time)
        driver.find_element_by_xpath("(//input[@name='TrainClass'])[2]").click()
        time.sleep(self.wait_time)
        driver.find_element_by_id("FromTimeSelect").click()
        time.sleep(self.wait_time)
        Select(driver.find_element_by_id("FromTimeSelect")).select_by_visible_text(param("FromTimeSelect", "07:00"))
        time.sleep(self.wait_time)
        driver.find_element_by_css_selector("option[value=\"0700\"]").click()
        time.sleep(self.wait_time)
        driver.find_element_by_id("ToTimeSelect").click()
        time.sleep(self.wait_time)
        Select(driver.find_element_by_id("ToTimeSelect")).select_by_visible_text(param("ToTimeSelect", "17:00"))
        time.sleep(self.wait_time)
        driver.find_element_by_css_selector("#ToTimeSelect > option[value=\"1700\"]").click()
        time.sleep(self.wait_time)
